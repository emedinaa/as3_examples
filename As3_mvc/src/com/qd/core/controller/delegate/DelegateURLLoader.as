package com.qd.core.controller.delegate
{
	...
	//import com.qd.projects.core.utils.Utils;
	...
	public class DelegateURLLoader extends EventDispatcher
	{
		...
		public function connect():void
		{
			...
			//Utils.traceForManu("Delegate url --------------s>> "+urlR.url);
			...
			if (parameter)
			{
				...
				{
					//trace(parameter[i].name + " "+parameter[i].valor);
					urlV[parameter[i].key] = parameter[i].value;
	...
	//	COMPLETE_APIFile_handler
		private function COMPLETE_Handler(e:Event):void 
		{
			...
			{
				//trace("Error data sin json --------------",urlL.data);
				evt.data = null;
			}
